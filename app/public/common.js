...
var PluginService = /** @class */ (function () {
    ...
    PluginService.prototype.StartPay = function (payRequst) {
        return this.http.post('/startPay', payRequst).toPromise();
    };
    PluginService.prototype.QueryPayResult = function (query) {
        return this.http.post('/queryPayResult', query).toPromise();
    };
    PluginService.prototype.Print = function (items) {
